...
- Minimum off-time before turning back on raised from 2 ticks (~10 min) to 12 ticks (1 hr)
- Both guards still bypass on genuine urgency (room above trigger threshold)
